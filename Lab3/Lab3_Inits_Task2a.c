//_____________________ Lab3_Inits_Task2a.c _____________________
/*
 * Caitlin DeShazo-Couchot and Ze Xu
 * Student ID: 2039775
 * February 14, 2023
 * EE/CSE 474: Lab3 Inits for task 2a main initializations
 */
...
void UART_Init(void) {
  volatile unsigned short delay = 0;
  RCGCUART |= 0x1; // enable clock to UART0
  RCGCGPIO |= 0x00000001; // enable clock to GPIO port A
  delay++;
  delay++;
  ...
  UARTLCRH_0 = 0x70; // set word length to 8 bit, keep everything else default
